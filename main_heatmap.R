...
#u_var   <- rep(1, 9) # constant susceptibility
...
HM <- foreach(country = countries) %dopar% {
  ...
  #   j <- i/100
  #   list_all[[paste0(i)]] <- run_sim_new(C_26, j, "all", num_perday, v_e_type, this_v_e)
  #   list_kids[[paste0(i)]] <- run_sim_new(C_26, j, "kids", num_perday, v_e_type, this_v_e)
  #   list_adults[[paste0(i)]] <- run_sim_new(C_26, j, "adults", num_perday, v_e_type, this_v_e)
  #   list_elderly[[paste0(i)]] <- run_sim_new(C_26, j, "elderly", num_perday, v_e_type, this_v_e)
  #   list_twentyplus[[paste0(i)]] <- run_sim_new(C_26, j, "twentyplus", num_perday, v_e_type, this_v_e)
  # } 
  # x_vec <- seq(1, 50, by = 1)
  ...
  # for (i in seq(0, 50, by = 1)){
  #   j <- i/100
  #   list_all[[paste0(i)]] <- run_sim_new(C_15, j, "all", num_perday, v_e_type, this_v_e)
  #   list_kids[[paste0(i)]] <- run_sim_new(C_15, j, "kids", num_perday, v_e_type, this_v_e)
  #   list_adults[[paste0(i)]] <- run_sim_new(C_15, j, "adults", num_perday, v_e_type, this_v_e)
  #   list_elderly[[paste0(i)]] <- run_sim_new(C_15, j, "elderly", num_perday, v_e_type, this_v_e)
  #   list_twentyplus[[paste0(i)]] <- run_sim_new(C_15, j, "twentyplus", num_perday, v_e_type, this_v_e)
  # } 
  # 
  # x_vec <- seq(1, 50, by = 1)
  ...
  for (i in seq(0, 50, by = 1)){
    j <- i/100
    list_all[[paste0(i)]] <- run_sim_new(C_115, j, "all", num_perday, v_e_type, this_v_e)
    list_kids[[paste0(i)]] <- run_sim_new(C_115, j, "kids", num_perday, v_e_type, this_v_e)
    list_adults[[paste0(i)]] <- run_sim_new(C_115, j, "adults", num_perday, v_e_type, this_v_e)
    list_elderly[[paste0(i)]] <- run_sim_new(C_115, j, "elderly", num_perday, v_e_type, this_v_e)
    list_twentyplus[[paste0(i)]] <- run_sim_new(C_115, j, "twentyplus", num_perday, v_e_type, this_v_e)
  }
  x_vec <- seq(1, 50, by = 1)
...
pdf("C:/Users/bubar/Documents/Vaccine Strategy/Plots/finaldraft_plots/heatmap_leaky_u_constant.pdf",
    height = 6, width = 10)
g
dev.off()
...
pdf("C:/Users/bubar/Documents/Vaccine Strategy/Plots/finaldraft_plots/heatmap_countries.pdf", 
    height = 6, width = 10)
g
dev.off()
