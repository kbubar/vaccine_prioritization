...
test <- run_sim_NTB(C, 0.01, "all", 0.01, ve_S, ve_I)
...
HM <- foreach(ve_I = ve_I_vec) %dopar% {
  ...
  for (i in seq(0, 50, by = 1)){
    j <- i/100
    list_all[[paste0(i)]] <- run_sim_NTB(C, j, "all", num_perday, ve_S, ve_I, ve_P)
    list_kids[[paste0(i)]] <- run_sim_NTB(C, j, "kids", num_perday, ve_S, ve_I, ve_P)
    list_adults[[paste0(i)]] <- run_sim_NTB(C, j, "adults", num_perday, ve_S, ve_I, ve_P)
    list_elderly[[paste0(i)]] <- run_sim_NTB(C, j, "elderly", num_perday, ve_S, ve_I, ve_P)
    list_twentyplus[[paste0(i)]] <- run_sim_NTB(C, j, "twentyplus", num_perday, ve_S, ve_I, ve_P)
  } 
  
  x_vec <- seq(1, 50, by = 1)
  I3 <- sapply(x_vec, FUN = function(x) get_best_strat_cases_NTB(x,
                                                                 list_all,list_kids,list_adults,
                                                                 list_elderly,list_twentyplus))
  M3 <- sapply(x_vec, FUN = function(x) get_best_strat_deaths_NTB(x,
                                                                  list_all,list_kids,list_adults,
                                                                  list_elderly,list_twentyplus))
  Y3 <- sapply(x_vec, FUN = function(x) get_best_strat_yll_NTB(x,
                                                               list_all,list_kids,list_adults,
                                                               list_elderly,list_twentyplus))
  ...
  I2 <- sapply(x_vec, FUN = function(x) get_best_strat_cases_NTB(x,
                                                                 list_all,list_kids,list_adults,
                                                                 list_elderly,list_twentyplus))
  M2 <- sapply(x_vec, FUN = function(x) get_best_strat_deaths_NTB(x,
                                                                  list_all,list_kids,list_adults,
                                                                  list_elderly,list_twentyplus))
  Y2 <- sapply(x_vec, FUN = function(x) get_best_strat_yll_NTB(x,
                                                               list_all,list_kids,list_adults,
                                                               list_elderly,list_twentyplus))
  ...
  for (i in seq(0, 50, by = 1)){
    j <- i/100
    list_all[[paste0(i)]] <- run_sim_NTB(C_low, j, "all", num_perday, ve_S, ve_I, ve_P)
    list_kids[[paste0(i)]] <- run_sim_NTB(C_low, j, "kids", num_perday, ve_S, ve_I, ve_P)
    list_adults[[paste0(i)]] <- run_sim_NTB(C_low, j, "adults", num_perday, ve_S, ve_I, ve_P)
    list_elderly[[paste0(i)]] <- run_sim_NTB(C_low, j, "elderly", num_perday, ve_S, ve_I, ve_P)
    list_twentyplus[[paste0(i)]] <- run_sim_NTB(C_low, j, "twentyplus", num_perday, ve_S, ve_I, ve_P)
  }

  I1 <- sapply(x_vec, FUN = function(x) get_best_strat_cases_NTB(x,
                                                                 list_all,list_kids,list_adults,
                                                                 list_elderly,list_twentyplus))
  M1 <- sapply(x_vec, FUN = function(x) get_best_strat_deaths_NTB(x,
                                                                  list_all,list_kids,list_adults,
                                                                  list_elderly,list_twentyplus))
  Y1 <- sapply(x_vec, FUN = function(x) get_best_strat_yll_NTB(x,
                                                               list_all,list_kids,list_adults,
                                                               list_elderly,list_twentyplus))
